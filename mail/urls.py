...
from mail.views import UpdateLicence, TestParallelRunOutgoing  # ManageInbox, SendLicenceUpdatesToHmrc, SendUsageUpdatesToLiteApi
...
urlpatterns = [
    ...
    path("parallel-run-outgoing/", TestParallelRunOutgoing.as_view(), name="parallel-run-outgoing"),
]

...
OUTGOING_EMAIL_PASSWORD = env("OUTGOING_EMAIL_PASSWORD")
OUTGOING_EMAIL_HOSTNAME = env("OUTGOING_EMAIL_HOSTNAME")
OUTGOING_EMAIL_USER = env("OUTGOING_EMAIL_USER")
OUTGOING_EMAIL_POP3_PORT = env("OUTGOING_EMAIL_POP3_PORT")
OUTGOING_EMAIL_SMTP_PORT = env("OUTGOING_EMAIL_SMTP_PORT")
